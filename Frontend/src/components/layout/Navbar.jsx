    ...
    <nav className="fixed top-0 w-full z-50 backdrop-blur-lg bg-white/80 dark:bg-black/80 border-b border-gray-200 dark:border-white/10">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 md:px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="hidden md:block px-5 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold hover:scale-105 transition">
            Get Started →
          </button>
      ...
      {open && (
        <div className="md:hidden flex flex-col items-center gap-4 py-6 bg-white dark:bg-black border-t border-gray-200 dark:border-white/10">
          ...
          <button onClick={()=> navigate('/signup')} className="px-6 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold">
            Get Started →
          </button>
        </div>
      )}
