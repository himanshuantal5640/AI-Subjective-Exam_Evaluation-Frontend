...
export default function StudentProfile() {
  ...
  <div className="flex justify-center p-6">
    ...
    bg-white dark:bg-[#0b1622] 
    border border-gray-200 dark:border-white/10
    rounded-3xl shadow-xl p-8 transition-all">
        ...
        <div className="relative">
          ...
          {editing && (
            <button
              ...
              className="absolute bottom-0 right-0 bg-cyan-500 p-2 rounded-full shadow-lg text-white"
            >
              <Camera size={16} />
            </button>
          )}
      ...
      <div className="mb-6">
        ...
        {editing ? (
          ...
          <p className="mt-2 text-gray-800 dark:text-white text-lg">
            {user.name}
          </p>
        )}
      </div>
